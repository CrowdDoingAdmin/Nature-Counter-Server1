...
```
cd existing_repo
git remote add origin https://gitlab.com/naturecountercrowddoing/Nature-Counter-Server.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/naturecountercrowddoing/Nature-Counter-Server/-/settings/integrations)
